...
const Checkout = {
                    ...
                    <div style="display:grid;gap:12px">
                        ...
                        <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px">
                            <div style="position:relative">
                              ...
                              <span id="cityStatus" style="position:absolute;right:8px;top:50%;transform:translateY(-50%);font-size:10px;color:#C9A020;pointer-events:none"></span>
                            </div>
                            <input id="sh_pincode" class="input-field" type="text" placeholder="Pincode" value="${profile?.pincode || ''}" maxlength="6" oninput="Checkout.lookupPin(this.value)">
                        </div>
    ...
    async lookupPin(pin) {
        ...
        if (!cityEl || pin.length !== 6 || !/^\d{6}$/.test(pin)) return;
